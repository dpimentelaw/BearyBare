...
function theme_files()
{
    ...
    wp_enqueue_style( 'bootstrap', 'gihttps://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css');
...
function staff_post_types() { 
    register_post_type('ceo',array (//This needs to be changed
